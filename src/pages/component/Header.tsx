...
const Header: React.FC<HeaderProps> = ({ text, back, alarm, review, search, className, setting}) => {
    ...
    return (
        <div>
            ...
            <div className={`${className} max-w-screen-sm w-[100%] h-[56px] top-0  left-50% px-5 z-50 fixed flex justify-between items-center pl-3 leading-[56px] ${ text && 'border-b border-[#E5E5E5]'}`}>
